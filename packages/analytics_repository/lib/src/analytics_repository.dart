...
/// {@template set_user_property_failure}
/// Thrown when setting the user property fails.
/// {@endtemplate}
class SetUserPropertyFailure extends AnalyticsFailure {
  /// {@macro set_user_property_failure}
  const SetUserPropertyFailure(super.error);
}
...
class AnalyticsRepo {
  ...
  const AnalyticsRepo(FirebaseAnalytics analytics) : _analytics = analytics;
  ...
  /// Sets the user property associated with tracked events.
  Future<void> setUserProperty(String name, String value) async {
    try {
      await _analytics.setUserProperty(name: name, value: value);
    } catch (error, stackTrace) {
      Error.throwWithStackTrace(SetUserPropertyFailure(error), stackTrace);
    }
  }
}
